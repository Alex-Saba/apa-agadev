...
* Indication explicite lorsque l'unite du produit n'est pas renseignee.

= 2026.8.4 =
* Journalisation des echecs des requetes API sans donnees sensibles ni en-tetes d'authentification.
* Retrait de la signature numerique de l'affichage du detail des demandes APA.

= 2026.8.3 =
* Restitution des documents deja joints lors de la consultation et de la modification d'une demande APA.
* Validation des champs obligatoires des etapes visitees avant l'enregistrement d'un brouillon.
* Affichage d'indications contextuelles sur les champs invalides afin de guider leur correction.
...
* Verification que chaque fournisseur conserve son type technique valide a la racine du payload.

= 2026.7.19 =
* Normalisation des options du formulaire APA afin de transmettre leurs valeurs techniques a Maivou.
* Correction de `providers[*].type` pour ne plus envoyer les index numeriques des options.
...
* Ajout d'un parcours dynamique entre les etapes du formulaire et adaptation responsive.
