...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { color: #1e2923; font-family: "DejaVu Sans", sans-serif; font-size: 9pt; line-height: 1.4; margin: 0; }
        table { border-collapse: collapse; }
        .document-header { border-top: 5px solid #dc6907; margin-bottom: 18px; padding-top: 13px; width: 100%; }
        .brand { color: #11663a; font-size: 8pt; font-weight: bold; letter-spacing: 1.4px; text-transform: uppercase; }
        .document-kind { color: #dc6907; font-size: 7.5pt; font-weight: bold; letter-spacing: 1px; margin-top: 15px; text-transform: uppercase; }
        h1 { color: #123c27; font-size: 22pt; line-height: 1.12; margin: 4px 0 0; overflow-wrap: break-word; }
        .header-status { text-align: right; vertical-align: bottom; width: 24%; }
        .status { border-collapse: separate; margin-left: auto; }
        .status td { background: #e8f5ed; border: 1px solid #b9d8c6; border-radius: 14px; color: #11663a; font-size: 8.5pt; font-weight: bold; height: 28px; padding: 0 12px; text-align: center; vertical-align: middle; }
        .meta { background: #f3f6f4; border: 1px solid #dae4de; border-radius: 8px; margin-bottom: 22px; padding: 10px 12px; width: 100%; }
        .meta td { padding: 5px 8px; vertical-align: top; width: 33.33%; }
        ...
        .section { margin: 0 0 20px; page-break-inside: auto; }
        ...
        .section-title { font-size: 13.5pt; font-weight: bold; line-height: 1.2; }
        ...
        .signature { background: #f7f9f8; border-left: 3px solid #dc6907; margin-top: 18px; padding: 10px 12px; page-break-inside: avoid; }
...
<body>
    <table class="document-header">
        <tr>
            <td>
                <div class="brand">MAIVOU <span style="color:#dc6907">/</span> AGADEV</div>
                <div class="document-kind"><?php esc_html_e('Demande d’accès et de partage des avantages', 'plugin-apa-agadev'); ?></div>
    ...
    <?php if ((string) ($agreement_detail['signature'] ?? '') !== '') : ?>
        <section class="signature">
            <div class="field-label"><?php esc_html_e('Signature numérique', 'plugin-apa-agadev'); ?></div>
